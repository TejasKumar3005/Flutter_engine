...
import 'package:engine/engine/level.dart';
...
class MyRouterComponent extends Component {
  final Map<String, Component Function()> routes;
  late Component currentComponent;

  MyRouterComponent({required this.routes, required String initialRoute}) {
    currentComponent = routes[initialRoute]!();
  }

  void goTo(String route) {
    currentComponent.removeFromParent();
    currentComponent = routes[route]!();
